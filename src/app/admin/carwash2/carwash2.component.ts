...
@Component({
  selector: 'app-carwash2',
  templateUrl: './carwash2.component.html',
  styleUrls: ['./carwash2.component.css']
})
export class Carwash2Component implements OnInit, AfterViewInit {
  public fecha = '';
  myForm: FormGroup;
  ord = 0;
  btn = '';
