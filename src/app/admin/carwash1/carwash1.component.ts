...
@Component({
  selector: 'app-carwash1',
  templateUrl: './carwash1.component.html',
  styleUrls: ['./carwash1.component.css']
})
export class Carwash1Component implements OnInit/* , AfterViewInit */ {
  public fecha = '';
  myForm: FormGroup;
  ord = 0;
  btn = '';
  ...
  ngOnInit(): void {
    ...
    $('#fecha1').html('Entrada: '+ this.fecha);
