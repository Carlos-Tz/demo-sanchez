...
@Component({
  selector: 'app-carwash3',
  templateUrl: './carwash3.component.html',
  styleUrls: ['./carwash3.component.css']
})
export class Carwash3Component implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    $('#fecha3').html('Entrada: '+ this.fecha);
