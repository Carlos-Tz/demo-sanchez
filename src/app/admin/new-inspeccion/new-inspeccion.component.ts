...
@Component({
  selector: 'app-new-inspeccion',
  templateUrl: './new-inspeccion.component.html',
  styleUrls: ['./new-inspeccion.component.css']
})
export class NewInspeccionComponent implements OnInit {
  ...
  ngOnInit() {
    this.sForm();
    this.formApi.GetInspeccionesList();
  ...
  submitSurveyData = () => {
    this.formApi.AddInspeccion(this.myForm.value);
